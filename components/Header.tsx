...
const Header: React.FC = () => (
  ...
  <Fragment>
    ...
    <Box p={[2, 4, 5]} width={['100%', '100%', 2/3, 2/3]} textAlign="center">
      ...
      <Heading as="h1" color="rgb(51, 68, 85)" mb={[3, 3, 5]} mt={[3, 3, 2]} textAlign="center">Koroonakaart</Heading>

      <Text mb={5} fontFamily="Space Mono" color="rgb(51, 68, 85, 0.8)">Statistika COVID-19 viiruse leviku kohta Eestis</Text>
    </Box>
  </Fragment>
);
