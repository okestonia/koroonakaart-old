...
const Header: React.FC = () => (
  ...
  <Fragment>
    ...
    <Box p={[2, 4, 5]} width={['100%', '100%', 2/3, 2/3]} textAlign="center">
      ...
      <Text mb={5} fontFamily="'Segoe UI', 'Helvetica Neue', Helvetica, Verdana, sans-serif;" color="rgb(51, 68, 85, 0.8)">Allolev informatsioon põhineb Eesti Vabariigi Terviseameti andmetel, mida uuendatakse uute andmete saabumisel.</Text>
      <List styleType="none" mb={4} fontFamily="'Segoe UI', 'Helvetica Neue', Helvetica, Verdana, sans-serif;" color="rgb(51, 68, 85, 0.8)">
