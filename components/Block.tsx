...
const Block:React.FC<BoxProps & BlockProps> = ({ children, footer, title, extraInfo, ...rest}) => (
  <StyledBox borderRadius={5} background="white" {...rest}>
    ...
    {children}
    {footer && <Flex py={5} px={2} m={0} minHeight={80} alignItems="center" justifyContent="center" textAlign="center" background="#f8f9fa" borderTop="solid 1px rgba(102,119,136,.15)" fontFamily="'Segoe UI', 'Helvetica Neue', Helvetica, Verdana, sans-serif;" fontSize="0.8em" color="gray.700"><div  dangerouslySetInnerHTML={{__html: footer}} /></Flex>}
  </StyledBox>
);
